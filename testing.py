...
class BasicTestSuite(unittest.TestCase):
    ...
    def  test_rips_fsms(self):
        ...
        assert(len(restricted_geodesic_machine.states) == 6)
        assert(len(restricted_geodesic_machine.transitions()) == 11)
        ...
        assert(len(geodesic_suffix_machine.states) == 16)
        assert(len(geodesic_suffix_machine.transitions()) == 52)
        ...
        assert(len(restricted_shortlex_machine.states) == 4)
        assert(len(restricted_shortlex_machine.transitions()) == 7)
        assert(len(geodesic_machine.states) == 41)
        assert(len(geodesic_machine.transitions()) == 330)
        assert(len(restricted_geodesic_machine.states) == 6)
        assert(len(restricted_geodesic_machine.transitions()) == 11)
        assert(len(letter_excluder.states) == 2)
        ...
        assert(len(geodesic_suffix_machine.states) == 58)
        assert(len(geodesic_suffix_machine.transitions()) == 454)
        ...
        assert(len(geodesic_machine.states) == 34)
        assert(len(geodesic_machine.transitions()) == 238)
        assert(len(restricted_geodesic_machine.states) == 5)
        assert(len(restricted_geodesic_machine.transitions()) == 10)
        assert(len(letter_excluder.states) == 2)
        ...
        assert(len(geodesic_suffix_machine.states) == 50)
        assert(len(geodesic_suffix_machine.transitions()) == 338)
